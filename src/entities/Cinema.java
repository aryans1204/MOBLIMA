...
//        int seatPurchased = //Need to pass in the index of the purchased;
        ...
        for (int r = 1; r < row + 1; r++) {
            for (int c = 0; c < col + 1; c++) {
                ...
                if (c == 0) {
                    ...
                    if(c % 4==0) {
                        if(gap)
                            System.out.print(seatsLayout[seatClass][seatStatus]+isleGap);
                        else
                            System.out.print(seatsLayout[seatClass][seatStatus]+seatGap);
                        gap = !gap;
                    }
                    else
                        System.out.print(seatsLayout[seatClass][seatStatus]+seatGap);
        ...
        System.out.printf("\t"+seatsLayout[0][0]+"\tAvailable \t\t"+seatsLayout[0][1]+"\tTaken\n");
        System.out.println("\tGold Seats");
        System.out.printf("\t"+seatsLayout[1][0]+"\tAvailable \t\t"+seatsLayout[1][1]+"\tTaken\n");
        System.out.println("\tPlatinum Seats");
        System.out.printf("\t"+seatsLayout[2][0]+"\tAvailable \t\t"+seatsLayout[2][1]+"\tTaken\n");
        System.out.println("\tCouple Seats");
        System.out.printf("\t"+seatsLayout[3][0]+"\tAvailable \t\t"+seatsLayout[3][1]+"\tTaken\n");
    }
