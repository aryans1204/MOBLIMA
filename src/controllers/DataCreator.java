...
public class DataCreator {
	...
	public static void main(String[] args) {
		...
		MovieController movie = new MovieController("movie.dat");
		...
		cinema.insertCinemaIntoDB("Cinema1", cinema1Mv, cinema1St);
		cinema.insertCinemaIntoDB("Cinema2", cinema2Mv, cinema2St);
		cinema.insertCinemaIntoDB("Cinema3", cinema3Mv, cinema3St);
		
		//Create CUSTOMERS
		client.insertCustomerToDB("John", 19, "john111", "test123", "john111@gmail.com", 84324783);
		client.insertCustomerToDB("Mary", 56, "mary222", "test123", "mary222@gmail.com", 81357852);
		client.insertCustomerToDB("Elizabeth", 25, "eliz333", "test123", "eliz333@gmail.com", 94327821);
		client.insertCustomerToDB("Ben", 65, "ben444", "test123", "ben444@gmail.com", 83178542);
		client.insertCustomerToDB("Jeffrey", 18, "jeff555", "test123", "jeff555@gmail.com", 96217568);
		...
		client.insertStaffToDB("Staff01", "test123", cinemas.get(0));
		client.insertStaffToDB("Staff02", "test123", cinemas.get(1));
		client.insertStaffToDB("Staff03", "test123", cinemas.get(2));
	}
