...
public class DataCreator {
    ...
    public static void main(String[] args) {
        ...
        CinemaController cinema = new CinemaController("cinemas.dat", "seats.dat");
        ClientController client = new ClientController("customers.dat", "staffs.dat");
        MovieController movie = new MovieController("movies.dat");
